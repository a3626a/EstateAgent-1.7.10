...
public class HandlerGeneralServer implements
		IMessageHandler<PacketGeneralServer, PacketGeneralClient> {

	@Override
	public PacketGeneralClient onMessage(PacketGeneralServer message,
			MessageContext ctx) {
		...
		case 0:
			...
			EstateAgent.simpleChannel.sendTo(msg1,
					MinecraftServer.getServer().getConfigurationManager()
							.func_152612_a(player1));
			break;
		case 1:
